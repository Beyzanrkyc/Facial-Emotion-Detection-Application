...
def get_dataloaders(path_to_fer_csv='fer2013.csv', tr_batch_sz=32, val_batch_sz=32):
    ...
    trainloader = utils.DataLoader(train_dataset, batch_size=tr_batch_sz, shuffle=True)
    validloader = utils.DataLoader(val_dataset, batch_size=val_batch_sz)
